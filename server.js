...
//Processes data sent in the body of the request
//It will create a property on req.body for each <input>,<select> or <textarea>
//in the form
app.use(express.urlencoded({ extended: false }));
//Add a cookied property for each cookie sent in the request
